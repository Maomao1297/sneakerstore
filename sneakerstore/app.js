    ...
    },
    {
    ...
    },
     {
        ...
        color: [
            {
                code: "pink",
                img: "./img/Product/skechers.png",
            },
            {
                code:"black",
                img: "./img/Product/skechers2.png",
            },
        ],
    },
]
...
const currentProducting = document.querySelector(".producting");
...
currentProductColors.forEach((color, index) => {
    color.addEventListener("click", () => {
        currentProducting.src = choosenProduct.colors[index].img;
    });
});
